...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Food Bank Distribution Management Hub";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Distribution Event";
process.env.TABLE_NAME = process.env.TABLE_NAME || "distribution_event_records";
'use strict';
